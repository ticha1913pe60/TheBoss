 ...
 */
public class LessonCalendarView extends DateControl {
     ...
     */
    public LessonCalendarView() {
        getStyleClass().add(DEFAULT_STYLE_CLASS);

        this.dayPage = new LessonDayPage();
        this.weekPage = new LessonWeekPage();
        this.monthPage = new LessonMonthPage();
        this.yearPage = new LessonYearPage();
        ...
        getProperties().addListener((Change<?, ?> change) -> {
            if (change.getKey().equals(SELECTED_PAGE)) {
                if (change.getValueAdded() != null) {
                    LessonPageBase page = (LessonPageBase) change.getValueAdded();
    ...
    private void fixSelectedPage() {
        LessonPageBase page = getSelectedPage();
    ...
    protected Skin<?> createDefaultSkin() {
        return new LessonCalendarViewSkin(this);
    }
     ...
     * @return the day page
     */
    public final LessonDayPage getDayPage() {
        return dayPage;
    }
     ...
     */
    public final LessonWeekPage getWeekPage() {
        return weekPage;
    }
     ...
     */
    public final LessonMonthPage getMonthPage() {
        return monthPage;
    }
     ...
     */
    public final LessonYearPage getYearPage() {
        return yearPage;
    }
    ...
    private final ReadOnlyObjectWrapper<LessonPageBase> selectedPage = new ReadOnlyObjectWrapper<>(this, "selectedPage");
     ...
     */
    public final ReadOnlyObjectProperty<LessonPageBase> selectedPageProperty() {
     ...
     * @return the selected page view
     */
    public final LessonPageBase getSelectedPage() {
