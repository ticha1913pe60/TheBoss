...
import com.petarzlatev.languageclasses.view.LessonMonthSheetView.DateCell;
import com.petarzlatev.languageclasses.view.LessonMonthSheetView.WeekDayLayoutStrategy;
...
public class LessonMonthSheetViewSkin extends DateControlSkin<LessonMonthSheetView> implements LoadDataSettingsProvider {
    ...
    public LessonMonthSheetViewSkin(LessonMonthSheetView control) {
        super(control);
    ...
    private DateCell buildCell(LocalDate date) {
        DateCell cell = getSkinnable().getCellFactory().call(new LessonMonthSheetView.DateParameter(getSkinnable(), date));
    ...
    private Node buildHeaderCell(YearMonth yearMonth) {
        return getSkinnable().getHeaderCellFactory().
                call(new LessonMonthSheetView.HeaderParameter(getSkinnable(), yearMonth));
    }
