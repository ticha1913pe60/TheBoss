...
public class LessonDetailedDayViewSkin extends DateControlSkin<LessonDetailedDayView> {
    ...
    public LessonDetailedDayViewSkin(LessonDetailedDayView view) {
        super(view);

        scrollBar = new ScrollBar();

        // the day view (scroll pane)
        LessonDayView dayView = view.getDayView();
    ...
    private void updateVisibilities() {
        ...
        final LessonDetailedDayView view = getSkinnable();
