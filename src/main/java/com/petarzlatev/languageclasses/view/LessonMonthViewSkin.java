...
public class LessonMonthViewSkin extends DateControlSkin<LessonMonthView> implements LoadDataSettingsProvider {
    ...
    public LessonMonthViewSkin(LessonMonthView view) {
        super(view);
    ...
    private void updateView() {
        ...
        LessonMonthView view = getSkinnable();
    ...
    class MonthDayView extends VBox {
        ...
        MonthDayView(LocalDate date, int week, int day) {
            ...
            LessonMonthView monthView = getSkinnable();
