 ...
 */
public class LessonDayEntryViewSkin extends SkinBase<LessonDayEntryView> {
    ...
    public LessonDayEntryViewSkin(LessonDayEntryView view) {
        super(view);
    ...
    protected void updateStyles() {
        LessonDayEntryView view = getSkinnable();
        Entry<?> entry = getEntry();
