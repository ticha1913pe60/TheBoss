...
public class LessonDetailedWeekView extends DayViewBase {
     ...
     */
    public LessonDetailedWeekView(int numberOfDays) {
        ...
        timeScaleView = new LessonWeekTimeScaleView();
    ...
    protected Skin<?> createDefaultSkin() {
        return new LessonDetailedWeekViewSkin(this);
    }
     ...
     */
    public final LessonWeekTimeScaleView getTimeScaleView() {
