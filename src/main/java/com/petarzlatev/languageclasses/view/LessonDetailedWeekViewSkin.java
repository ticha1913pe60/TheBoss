...
public class LessonDetailedWeekViewSkin extends DateControlSkin<LessonDetailedWeekView> {
    ...
    public LessonDetailedWeekViewSkin(LessonDetailedWeekView view) {
        super(view);

        LessonWeekView weekView = view.getWeekView();
        ...
        LessonWeekTimeScaleView timeScale = view.getTimeScaleView();
    ...
    private void updateVisibilities() {
        ...
        final LessonDetailedWeekView view = getSkinnable();
