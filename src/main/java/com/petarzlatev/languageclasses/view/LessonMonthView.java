 ...
 * <p/>
 */
public class LessonMonthView extends MonthViewBase implements ZonedDateTimeProvider {
    ...
    protected Skin<?> createDefaultSkin() {
        return new LessonMonthViewSkin(this);
    }

    @Override
    public final ZonedDateTime getZonedDateTimeAt(double x, double y) {
    	LessonMonthViewSkin skin = (LessonMonthViewSkin) getSkin();
