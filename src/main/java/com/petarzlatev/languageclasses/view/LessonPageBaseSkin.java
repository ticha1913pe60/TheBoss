...
public abstract class LessonPageBaseSkin<C extends LessonPageBase> extends SkinBase<C> {

    private Text dateText;
    private BorderPane headerPane;
    private BorderPane borderPane;

    public LessonPageBaseSkin(C page) {
        super(page);
        ...
        backButton.getStyleClass().add("lesson-previous-date-button");
        forwardButton.getStyleClass().add("lesson-next-date-button");
        todayButton.getStyleClass().add("lesson-today-button");
