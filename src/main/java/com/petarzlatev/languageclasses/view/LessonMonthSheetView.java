 ...
 */
public class LessonMonthSheetView extends DateControl {
    ...
    protected Skin<?> createDefaultSkin() {
        return new LessonMonthSheetViewSkin(this);
    }
    ...
    public static final class DateParameter {
        ...
        private LessonMonthSheetView view;
         ...
         */
        public DateParameter(LessonMonthSheetView view, LocalDate date) {
         ...
         */
        public LessonMonthSheetView getView() {
            return view;
        }
    ...
    public static final class HeaderParameter {
        ...
        public HeaderParameter(LessonMonthSheetView view, YearMonth yearMonth) {
            this.view = Objects.requireNonNull(view);
            this.yearMonth = yearMonth;
        }

        public final LessonMonthSheetView getView() {
            return view;
        }
    ...
    public static class MonthHeaderCell extends Label {
        ...
        private final LessonMonthSheetView view;
         ...
         */
        public MonthHeaderCell(LessonMonthSheetView view, YearMonth yearMonth) {
         ...
         */
        public MonthHeaderCell(LessonMonthSheetView view, YearMonth yearMonth, TextStyle textStyle) {
            this.view = Objects.requireNonNull(view);
    ...
    public static abstract class DateCell extends Region {
         ...
         */
        public DateCell(LessonMonthSheetView view, LocalDate date) {
            this.view = Objects.requireNonNull(view);
            this.date = date;
    ...
    public static class DetailedDateCell extends SimpleDateCell {
         ...
         * @param date the date shown by the cell (might be null for leading or trailing empty cells)
         */
        public DetailedDateCell(LessonMonthSheetView view, LocalDate date) {
            super(view, date);
    ...
    public static class BadgeDateCell extends SimpleDateCell {
         ...
         * @param date the date shown by the cell (might be null for leading or trailing empty cells)
         */
        public BadgeDateCell(LessonMonthSheetView view, LocalDate date) {
            super(view, date);
    ...
    public static class SimpleDateCell extends DateCell {
         ...
         * @param date the date shown by the cell (might be null for leading or trailing empty cells)
         */
        public SimpleDateCell(LessonMonthSheetView view, LocalDate date) {
            super(view, date);
        ...
        private void updateLabels() {
            ...
            if (date == null) {
                ...
                LessonMonthSheetView view = getView();
    ...
    public static class UsageDateCell extends SimpleDateCell {
         ...
         * @param date the date shown by the cell (might be null for leading or trailing empty cells)
         */
        public UsageDateCell(LessonMonthSheetView view, LocalDate date) {
            super(view, date);
        }
