 ...
 * <p/>
 */
public class LessonWeekView extends DayViewBase {
     ...
     */
    public LessonWeekView(int numberOfDays) {
        getStyleClass().add(DEFAULT_STYLE_CLASS);

        setWeekDayViewFactory(param -> new LessonWeekDayView());
    ...
    protected Skin<?> createDefaultSkin() {
        return new LessonWeekViewSkin(this);
    }

    @Override
    public ZonedDateTime getZonedDateTimeAt(double x, double y) {
        final LessonWeekDayView view = getWeekDayViewAt(x);
        if (view != null) {
    ...
    private LessonWeekDayView getWeekDayViewAt(double x) {
        for (LessonWeekDayView view : getWeekDayViews()) {
    ...
    private final ObservableList<LessonWeekDayView> weekDayViews = FXCollections.observableArrayList();
     ...
     */
    public final ObservableList<LessonWeekDayView> getWeekDayViews() {
        return weekDayViews;
    }
    ...
    public static final class WeekDayParameter {
        ...
        private LessonWeekView weekView;
         ...
         */
        public WeekDayParameter(LessonWeekView weekView) {
         ...
         */
        public LessonWeekView getWeekView() {
            return weekView;
        }
    }

    private final ObjectProperty<Callback<WeekDayParameter, LessonWeekDayView>> weekDayViewFactory = new SimpleObjectProperty<>(this, "weekDayViewFactory"); //$NON-NLS-1$
     ...
     */
    public final ObjectProperty<Callback<WeekDayParameter, LessonWeekDayView>> weekDayViewFactoryProperty() {
     ...
     * @return the week day view factory
     */
    public final Callback<WeekDayParameter, LessonWeekDayView> getWeekDayViewFactory() {
     ...
     */
    public final void setWeekDayViewFactory(Callback<WeekDayParameter, LessonWeekDayView> factory) {
