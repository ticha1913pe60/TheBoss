...
import static com.petarzlatev.languageclasses.view.LessonYearMonthView.ClickBehaviour.PERFORM_SELECTION;
 ...
 * <p/>
 */
public class LessonYearMonthView extends MonthViewBase {

	/**
	 * Constructs a new view.
	 */
	public LessonYearMonthView() {
	...
	protected Skin<?> createDefaultSkin() {
		return new LessonYearMonthViewSkin(this);
	}
	...
	private final ObjectProperty<Callback<LessonYearMonthView, DateCell>> cellFactory = new SimpleObjectProperty<>(this,
			"cellFactory"); //$NON-NLS-1$

	/**
	 * A factory for creating alternative content for the month view. The image
	 * below shows the {@link YearMonthView} once with the default factory and once
	 ...
	 */
	public final ObjectProperty<Callback<LessonYearMonthView, DateCell>> cellFactoryProperty() {
		return cellFactory;
	}
	 ...
	 */
	public final void setCellFactory(Callback<LessonYearMonthView, DateCell> factory) {
	 ...
	 * @return the cell factory
	 */
	public final Callback<LessonYearMonthView, DateCell> getCellFactory() {
		return cellFactoryProperty().get();
	}

	private final BooleanProperty showMonth = new SimpleBooleanProperty(this, "showMonth", true); //$NON-NLS-1$
	 ...
	 *
	 * @param show if true the month will be shown
	 */
	...
	private final BooleanProperty showYear = new SimpleBooleanProperty(this, "showYear", true); //$NON-NLS-1$
	 ...
	 *
	 * @param show if true the year will be shown
	 */
	...
	private final BooleanProperty showTodayButton = new SimpleBooleanProperty(this, "showTodayButton", true); //$NON-NLS-1$
	...
	private final BooleanProperty showMonthArrows = new SimpleBooleanProperty(this, "showMonthArrows", true); //$NON-NLS-1$
	...
	private final BooleanProperty showYearArrows = new SimpleBooleanProperty(this, "showYearArrows", true); //$NON-NLS-1$
	...
	private final BooleanProperty showUsageColors = new SimpleBooleanProperty(this, "showUsageColors", false); //$NON-NLS-1$

	/**
	 * Show or hide usage colors that are based on the number of entries on a given
	 * date. The image below shows those colors in action:
	 * <p/>
	 ...
	 *
	 * @param show if true will show the colors
	 */
	...
	/**
	 * An enumerator to control the behaviour of the control when the user clicks on
	 * a date.
	 *
	...
	private final ObjectProperty<ClickBehaviour> clickBehaviour = new SimpleObjectProperty<>(this, "clickBehaviour", //$NON-NLS-1$
			PERFORM_SELECTION);
