 ...
 */
public class LessonWeekPage extends LessonPageBase {

    private final LessonDetailedWeekView detailedWeekView;
     ...
     */
    public LessonWeekPage() {
        getStyleClass().add("week-page"); //$NON-NLS-1$
        setDateTimeFormatter(DateTimeFormatter.ofPattern(Messages.getString("WeekPage.DATE_FORMAT"), Locale.getDefault())); //$NON-NLS-1$

        this.detailedWeekView = new LessonDetailedWeekView();
    ...
    protected Skin<?> createDefaultSkin() {
        return new LessonWeekPageSkin(this);
    }
