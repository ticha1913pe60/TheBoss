...
public class LessonWeekTimeScaleViewSkin extends TimeScaleViewSkin<LessonWeekTimeScaleView> {

	public LessonWeekTimeScaleViewSkin(LessonWeekTimeScaleView scale) {
		super(scale);
	}

	@Override
	protected boolean isShowingTimeMarker() {
		LessonWeekTimeScaleView dayView = getSkinnable();
		LessonDetailedWeekView weekView = dayView.getDetailedWeekView();
